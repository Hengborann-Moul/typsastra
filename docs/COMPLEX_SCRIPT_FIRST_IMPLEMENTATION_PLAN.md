...
- [x] **P6.3 — Implement standalone preview rules.** This implementation was subsequently disabled after source-sync reliability regressions. Its portable replacement is planned for v0.6.0; v1.x qualification is tracked by `V1X-P.1`.
